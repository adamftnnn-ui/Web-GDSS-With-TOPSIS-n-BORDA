...
const {  getAllUser, getUserById, updateUser, ubahPassword, createUser, deleteUser, getTotalUser, getInisialUser, getAllDm } = require('../controllers/userController')
...
router.route('/find/dm').get(getAllDm)
